...
public class Main {
    public static void main(String[] args) {
        ...
        // Neste caso, é então assumido o valor 21 para X enquanto os valores 21 e 15 devem ser desconsiderados pois são
        // menores ou iguais a X.
        // Como o valor 30 está dentro da especificação (maior do que X) ele será válido e então deve-se processar os
        // cálculos para apresentar na saída o valor 2, pois é a quantidade de valores somados para se produzir um
        // valor maior do que 30 (21 + 22).
        //
        //Entrada
        ...
        // Se Z não atender a especificação do problema, ele deverá ser lido novamente,
